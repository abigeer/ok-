...
function listClick(value){
	if(value == 1){
		$("#crowdfunding_iframe", window.parent.document).attr("src","myInfo");
	...
	if(value == 3){
		$("#crowdfunding_iframe", window.parent.document).attr("src","identityProve");
		$("#crowdfunding_iframe", window.parent.document).attr("height",1045);
	...
	if(value == 4){
		$("#crowdfunding_iframe", window.parent.document).attr("src","changePassword");
		$("#crowdfunding_iframe", window.parent.document).attr("height",1045);
		$("#listClick1", window.parent.document).attr("class","");
		$("#listClick3", window.parent.document).attr("class","");
