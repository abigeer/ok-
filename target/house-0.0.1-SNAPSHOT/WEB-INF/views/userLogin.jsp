...
<body>
    <div id="login_bg" class ="login_bg" style="background-image:url(${pageContext.request.contextPath}/static/img/login_bg.jpg);"></div>
            	...
            	<div id="signup_forms_container" class="signup_forms_container">
                    	<form class="signup_form_form" id="sign_form" method="post" action="checklogin.jsp">
                        	<div class="signup_account" id="signup_account">
                            	<div class="form_user">	
        							<input type="text" name="email" placeholder="用户名/手机号" id="signup_email"><p id="accountMsg"></p>
                                </div>
    ...
    <div class="footer">
    	<div class="footer_signup_link">
        	<a class="signup_link" href="${pageContext.request.contextPath }/user/userRegist">注册</a>
        </div>
