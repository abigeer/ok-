...
function listClick(value){
	if(value == 1){
		...
		$("#crowdfunding_iframe").attr("src","myInfo");
	...
	if(value == 2){
		$("#crowdfunding_iframe").attr("src","changeHeader");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 3){
		...
		$("#crowdfunding_iframe").attr("src","identityProve");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 4){
		...
		$("#crowdfunding_iframe").attr("src","changePassword");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 6){
		//用户订单
		$("#crowdfunding_iframe").attr("src","myOrder");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 8){
		//成为房主
		$("#crowdfunding_iframe").attr("src","toMaster");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 9){
		$("#crowdfunding_iframe").attr("src","manageMyHouseSource?pageNum=1");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
	...
	if(value == 10){
		$("#crowdfunding_iframe").attr("src","toCreatHouse");
		$("#crowdfunding_iframe").attr("height","1045");
		$("#vertical_navigation").css("height","1050px");
